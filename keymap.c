...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_ansi_67(
        KC_CAPS,    KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,    RGB_VAD,    RGB_VAI,  KC_MPRV,    KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,     KC_VOLU,  _______,          _______,
        XXXXXXX,    XXXXXXX,  XXXXXXX,  KC_LBRC,  KC_RBRC,    KC_TILD,    XXXXXXX,  KC_PGUP,    KC_HOME,  KC_END,   KC_PGDN,    XXXXXXX,     _______,  _______,          _______,
    ...
    [_FN3] = LAYOUT_ansi_67(
        ...
        QK_RBT,  RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,            _______,                _______,
